I grew up in Kolkata, wanting to be a Physicist. For all its flaws, I have always wanted to solve really hard problems.[^1] I am currently on leave at Rice University where I studied Mathematics and Electrical Engineering. Some things about me:

- I'm currently building [Optica Industries](https://optica.industries/)
- I love [writing](https://www.ahidas.com/essays), creating at the intersection of intelligence & embodiment, and startups. Startups are the highest leverage way to run an experiment on reality. Everything else is commentary.
...
I am working towards realising what I want the outcome of my life to be. There's a lot I do not know, but here are some things I believe:
...
- The physical world is under-indexed. The most important problems left are ones you can touch.
    ...
    - Manufacturing is a leverage point most technologists ignore.
    - Software ate the world but is choking on atoms. The next decade belongs to people who can do both.
...
- On How To Think
    - First principles thinking is only useful if you actually know enough principles. Most people skip that part.
    - Depth is a competitive advantage that compounds.
        - The interesting stuff is always one layer deeper.
        - Go deep fast. Depth without urgency is just procrastination.
    ...
    - The scientific method is underrated in industry: Form a hypothesis. Test it cheaply. Update hard. Almost nobody actually does this.
- On Building
...
- A complete theory of intelligence. It is crucial towards cracking general intelligence.

[^1]: Kuhn, Ben. ["You Don't Need to Work on Hard Problems."](http://www.benkuhn.net/hard/) *benkuhn.net*, Feb. 2020.
